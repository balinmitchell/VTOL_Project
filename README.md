...
After running the flight control code on the Arduino Nano it was clear that the speed would be limitng factor. A maximum of 250Hz was reached during testing.
